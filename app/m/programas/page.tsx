...
async function getAnnouncements() {
  try {
    ...
    console.error('Error fetching announcements for mobile /programas:', error)
    return []
  }
}

export default async function MobileProgramasPage() {
  const announcements = await getAnnouncements()
  return <HomeMobile announcements={announcements} targetId="programas" />
}
