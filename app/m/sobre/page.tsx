...
async function getAnnouncements() {
  try {
    ...
    console.error('Error fetching announcements for mobile /sobre:', error)
    return []
  }
}

export default async function MobileSobrePage() {
  const announcements = await getAnnouncements()
  return <HomeMobile announcements={announcements} targetId="sobre" />
}
