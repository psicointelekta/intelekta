...
async function getAnnouncements() {
  try {
    ...
    console.error('Error fetching announcements for mobile /equipe:', error)
    return []
  }
}

export default async function MobileEquipePage() {
  const announcements = await getAnnouncements()
  return <HomeMobile announcements={announcements} targetId="equipe" />
}
