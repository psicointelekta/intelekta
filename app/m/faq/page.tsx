...
async function getAnnouncements() {
  try {
    ...
    console.error('Error fetching announcements for mobile /faq:', error)
    return []
  }
}

export default async function MobileFaqPage() {
  const announcements = await getAnnouncements()
  return <HomeMobile announcements={announcements} targetId="faq" />
}
