...
async function getAnnouncements() {
  try {
    ...
    console.error('Error fetching announcements for mobile /depoimentos:', error)
    return []
  }
}

export default async function MobileDepoimentosPage() {
  const announcements = await getAnnouncements()
  return <HomeMobile announcements={announcements} targetId="depoimentos" />
}
