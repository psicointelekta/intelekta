...
async function getAnnouncements() {
  try {
    ...
    console.error('Error fetching announcements for /programas:', error)
    return []
  }
}
...
export default async function ProgramasPage() {
  ...
  const jsonLd = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "Programas",
        "item": "https://psicointelekta.com.br/programas"
      }
    ]
  }
  ...
  return (
    <>
      ...
      />
      <HomeDesktop announcements={announcements} targetId="programas" />
    </>
  )
}
